  ...
  >
    <g id="attic-icon">
      <g id="base">
        <path
          id="Vector 15"
          d="M4.5 28C4.5 28.2761 4.72386 28.5 5 28.5C5.27614 28.5 5.5 28.2761 5.5 28H4.5ZM4.5 15V28H5.5V15H4.5Z"
          fill="black"
        />
        <path
          id="Vector 16"
          d="M30.5 28C30.5 28.2761 30.7239 28.5 31 28.5C31.2761 28.5 31.5 28.2761 31.5 28H30.5ZM30.5 15V28H31.5V15H30.5Z"
          fill="black"
        />
...
export { AtticIcon as ReactComponent }
